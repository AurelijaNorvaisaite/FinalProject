...
urlpatterns = [
    ...
    path('cost-expense_type-form/', cost_type_view, name='cost_type_view'),
    ...
    path('expense_supplier-autocomplete', SupplierAutocomplete.as_view(), name='expense_supplier-autocomplete')
]
